...
import {AuthorController} from '../controllers/admin/author_controller'
...
author_route.post('/addauthor',rolemiddleware.jwtAuthRole,validationmiddleware.validator,author_controller.createAuthor)
author_route.get('/getauthorbyid/:id',author_controller.getAuthorById)
author_route.put('/updateauthor/:id',rolemiddleware.jwtAuthRole,validationmiddleware.validator,author_controller.updateAuthor)
