...
category_route.post('/addcategory',rolemiddleware.jwtAuthRole,validationmiddleware.validator,category_controller.createCategory)
category_route.get('/getcategorybyid/:id',category_controller.getCategoryById)
category_route.put('/updatecategory/:id',rolemiddleware.jwtAuthRole,validationmiddleware.validator,category_controller.updateCategory)
